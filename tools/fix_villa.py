...
FIXES = {
    "277": {"name": "No.12 Kashima Fan Zone",
            "reason": "アート・音楽・飲食・温浴を集めた複合施設で、サウナは日帰り客も利用する共用の温浴施設。FAQに「No.12は、施設利用と温浴（サウナ）利用で決済バンドが異なっております」「サウナご利用時は、サウナ利用者専用の決済バンドをお渡しします。皆様にサウナを快適にご利用いただくために利用者数を制限しております」とあり、宿泊とは別枠の有料温浴施設として運営されている。また「10時〜22時までは一般のお客様もいらっしゃるため、外出の際はお手数ですがフロントまでお声がけください」とも記載。宿泊者専用ではないため shared に訂正する（2026-08確認）",
            "remove_tags": ["sauna"],
            "set_spec": {"sauna_exists": {"v": "shared", "src": "desk", "at": "2026-08",
                                          "url": "https://no-12.jp/faq/"}}},
}
