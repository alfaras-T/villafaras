...
FIXES = {
    "239": {"name": "AMAO VILLA",
            "reason": "**AMAO VILLA 5施設の間でフィールドが混線していた。** 交差検証で判明。\n\n当初は「一休のアクセスが富戸911-122でDBの富戸1007-32と違う」ことから同名の別施設を疑ったが、そうではなかった。公式FAQで AMAO VILLA は熱海／伊豆高原／城ヶ崎／富戸／自然郷の5施設で、富戸は1つだけと確認できた。\n\n  addr    … 富戸1007-32 は **AMAO VILLA 伊豆高原** の住所\n  feature … 「2024年に開業したばかりの**AMAO VILLA 城ヶ崎**は…」＝城ヶ崎の紹介文\n  desc    … 「**熱海**の雄大な景色を…**熱海海上花火**を一年中楽しめます」＝熱海の紹介文\n  official / ota.ikyu … どちらも富戸で正しい\n\naddr は一休「〒413-0231 静岡県伊東市富戸911-122」と Google マップの「AMAO VILLA 富戸」の事業者情報が一致したので訂正する。\n\n**pet_ok を yes から no に訂正する。** 独立した3つの出典が一致している。\n  一休 基本情報「ペット　不可」および設備・特徴「× ペット可」\n  公式から直接リンクする予約システム beds24「**ペット：不可**」\n  公式FAQ の見出し「**AMAO VILLA 富戸 (※犬との宿泊は不可)**」\nあわせて pet タグを外す。同じ beds24 の基本情報が「**BBQ：なし**」なので bbq タグも外す。\n\n**feature と desc は姉妹施設の文章のままで、利用者に見える誤りとして残る。**富戸自身の一次情報から書き起こす必要があるため今回は触らない。capacity=9 / sauna_cap=8 / sauna_temp=95 は富戸公式の記載と一致しているので触らない。（2026-09確認）",
            "set_villa": {"addr": "静岡県伊東市富戸911-122"},
            "set_spec": {"pet_ok": {"v": "no", "src": "desk", "at": "2026-09",
                                    "url": "https://www.amaovilla.com/faq/"}},
            "remove_tags": ["pet", "bbq"],
            },
    "248": {"name": "エンゼルフォレスト中伊豆",
            "reason": "**capacity を 4 から 6 に訂正する。** 公式の予約システムで棟一覧を確認したところ棟種別は2つだけ。\n\n  「【プライベートドッグラン付き】新築貸別荘コテージ1LDK（洋室1部）・**4名定員**）」…露天風呂付でサウナの記載なし\n  「【プライベートドッグラン＆サウナ付き】新築貸別荘コテージ2LDK（洋室2部）・**6名定員**）」\n\n既存の4はサウナの無いスタンダード棟の数字だった（DBの sauna_exists は room で、サウナがあるのは6名タイプのみという実態と整合する）。公式FAQ「1部屋に最大何人まで宿泊できますか？」の回答は「貸別荘やコテージにより定員は異なります。詳細は各貸別荘・コテージをご確認ください。」で施設全体の数字を出していない。棟別の最大を採る規約に従い 6 とする。（2026-09確認）",
    ...
    "283": {"name": "THE BOTANICAL RESORT 林音（リンネ）",
            "reason": "**capacity を 4 から 7 に訂正する。** 公式の宿泊一覧はグランピング4種＋コテージ7種の計11タイプで、定員は「2〜4名」が中心だが最大は\n\n  「部屋名　**クラブメゾネットコテージ**　面積　86.12㎡　定員　**2〜7名**※3歳未満は添い寝可」\n\n（この個別ページの所在地「〒311-0122 茨城県那珂市戸4369-1」がDBの addr と一致し、同一施設であることも確認できた）。FAQ 全55問を確認したが施設全体の最大人数は出ていない。棟別の最大を採る規約に従い 7 とする。\n\n**ただしこの規約の限界が見えた案件でもある。** id=113 / 150 / 191 は同一ヴィラの棟違いだったが、林音は11タイプあり、グランピングテントと2階建てコテージという性質の違う商品群が混在する。「施設として最大7名まで泊まれる」は正しいが、テントを取った利用者には当てはまらない。1エントリ＝1施設という構造の限界。（2026-09確認）",
            "set_villa": {"capacity": "7"},
            "set_spec": {"capacity": {"v": 7, "src": "desk", "at": "2026-09",
                                      "url": "https://rinne-resort.jp/stay/maisonette"}},
            },
}
