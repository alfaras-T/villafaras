...
FIXES = {
    "215": {"name": "マイグレテラス",
            "reason": "**sauna_type=tent を削除する。別施設のバナー広告からの誤読だった。** 公式ページ全体で「テント」の語が出てくるのは1箇所だけで、それは姉妹施設の宣伝バナー\n\n  「『マイグレ天』は、本格的なフィンランド式テントサウナでロウリュを楽しめます」\n\n**これはマイグレテラスではなくマイグレ天の説明。** マイグレテラス自身の記述は「緑に囲まれた庭のデッキにはオーナーのこだわりが詰まったサウナと露天風呂」で、テントの語も構造の明記も無い。しかも部屋一覧は「1F：シアタールーム、テラス、**サウナ**、寝室①、寝室②、トイレ」と屋内の1室として数えており、「庭のデッキに」という記述と両立しないため、構造は確定できない。未調査に戻す。\n\nこの値は出典URLの無い2026-07の一括投入分だった。（2026-09確認）",
