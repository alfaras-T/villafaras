...
FIXES = {
    "185": {"name": "SAUNA VILLA 然",
            "reason": "公式サイトの客室紹介で「※デラックスツインにサウナ設備はございません」と明記されている。スイート（84㎡・定員2〜6名）とジュニアスイート（49㎡・定員1〜2名）にはプライベートサウナがあるが、デラックスツイン（23㎡・定員1〜2名）にはない。「スイート、ジュニアスイートにはセルフロウリュが可能なプライベートサウナ、水風呂、屋外プライベートデッキ、キッチンがあり」とトップにも記載。一部客室のみのため room に訂正する（2026-08確認）",
            "set_spec": {"sauna_exists": {"v": "room", "src": "desk", "at": "2026-08",
                                          "url": "https://villazen.jp/"}}},
}
