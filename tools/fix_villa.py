...
FIXES = {
    "4": {"name": "るうふ別邸 鴨川919",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Kamogawa-Hotels-Kamogawa-919.h126080277.Hotel-Information"},
            },
    "24": {"name": "BEST SPA 99",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Oamishirasato-Hotels-Best-Spa-99.h125745984.Hotel-Information"},
            },
    "33": {"name": "and RIVER勝浦",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Katsuura-Hotels-And-RIVER-Katsuura.h118014029.Hotel-Information"},
            },
    "62": {"name": "RICKA KATSUURA",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Katsuura-Hotels-RICKA-KATSUURA.h111407840.Hotel-Information"},
            },
    "73": {"name": "SANU 2nd Home 南アルプス1st",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Hokuto-Hotels-SANU-2nd-Home-Minami-Alps-1st.h124943304.Hotel-Information"},
            },
    "74": {"name": "SANU 2nd Home 八ヶ岳2nd",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Hokuto-Hotels-SANU-2nd-Home-Yatsugatake-2nd.h119731996.Hotel-Information"},
            },
    "76": {"name": "SANU 2nd Home 河口湖2nd",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Narusawa-Hotels-SANU-2nd-Home-Kawaguchiko-2nd.h118011004.Hotel-Information"},
            },
    "86": {"name": "hotel norm. air",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Fujikawaguchiko-Hotels-Hotel-Norm-Air.h105176288.Hotel-Information"},
            },
    "87": {"name": "hotel norm. ao",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Fujikawaguchiko-Hotels-Hotel-Norm-Ao.h126443676.Hotel-Information"},
            },
    "88": {"name": "hotel norm. fuji",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Fujikawaguchiko-Hotels-Hotel-Norm-Fuji.h107087492.Hotel-Information"},
            },
    "94": {"name": "abrAsus hotel Fuji",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Narusawa-Hotels-Abrasus-Hotel-Fuji.h123818896.Hotel-Information"},
            },
    "98": {"name": "SILVER SPRAY 山中湖",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Yamanakako-Hotels-Pension-Silver-Spray.h38510736.Hotel-Information"},
            },
    "115": {"name": "有形文化財ホテル 飯塚邸",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Nakagawa-Hotels-Iizukatei.h42053707.Hotel-Information"},
            },
    "116": {"name": "Kito NASU",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Nasu-Hotels-Kito-Nasu.h126080821.Hotel-Information"},
            },
    "118": {"name": "SANU 2nd Home 那須1st",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Nasu-Hotels-SANU-2nd-Home-Nasu-1st.h119729894.Hotel-Information"},
            },
    "119": {"name": "SANU 2nd Home 那須2nd",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/SANU-2nd-Home-Nasu-2nd.h119730779.Hotel-Information"},
            },
    "120": {"name": "SANU 2nd Home 那須3rd",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Nasu-Hotels-SANU-2nd-Home-Nasu-3rd.h119731250.Hotel-Information"},
            },
    "127": {"name": "VillaEL5",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Nikko-Hotels-Villa-EL-5.h78347676.Hotel-Information"},
            },
    "132": {"name": "GEOSPOT MOTOHAKONE A",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Hakone-Hotels-GEOSPOT-MOTOHAKONE-A.h122405299.Hotel-Information"},
            },
    "138": {"name": "Casablanca Villa Hakone",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Hakone-Hotels-Casablanca-Villa-Hakone.h121149337.Hotel-Information"},
            },
    "145": {"name": "ICHI-VILLA CROSSROAD HAKONE",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Hakone-Hotels-ICHI-VILLA-CROSSROAD-HAKONE.h127366377.Hotel-Information"},
            },
    "159": {"name": "葉山THE・TERRACE　HOUSE",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Yokohama-Hotels-1minute-Walk-To-The-Sea-Sauna-BBQ-Isshiki-Bea-Miura-County-Kanagawa.h125319204.Hotel-Information"},
            },
    "161": {"name": "Oceanfront Villa Hale Kahakai",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Yokohama-Hotels-Oceanfront-Villa-Hale-Kahakai.h71606441.Hotel-Information"},
            },
    "176": {"name": "SANU 2nd Home 北軽井沢2nd",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Tsumagoi-Hotels-SANU-2nd-Home-Kitakaruizawa-2nd.h118014288.Hotel-Information"},
            },
    "177": {"name": "SANU 2nd Home 蓼科1st",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Chino-Hotels-SANU-2nd-Home-Tateshina-1st.h124943452.Hotel-Information"},
            },
    "178": {"name": "SANU 2nd Home 軽井沢2nd",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Miyota-Hotels-SANU-2nd-Home-Karuizawa-2nd.h124943208.Hotel-Information"},
            },
    "179": {"name": "SANU 2nd Home 白馬1st",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Hakuba-Hotels-SANU-2nd-Home-Hakuba1st.h118286601.Hotel-Information"},
            },
    "191": {"name": "軽井沢 HOUSE VILLA",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Karuizawa-Hotels-KARUIZAWAHOUSE-VILLA.h103121721.Hotel-Information"},
            },
    "195": {"name": "Earthboat Kurohime",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Shinano-Hotels-Earthboat-Village-Kurohime.h128970392.Hotel-Information"},
            },
    "234": {"name": "COCO VILLA 伊豆赤沢",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Ito-Hotels-COCO-VILLA-Izu-Akazawa-Private-Sauna-Villa.h127497820.Hotel-Information"},
            },
    "246": {"name": "SANU 2nd Home 伊豆1st",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Ito-Hotels-SANU-2nd-Home-Izu-1st.h119728594.Hotel-Information"},
            },
    "273": {"name": "HOLE37",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Tsukuba-Hotels-HOLE37.h96541840.Hotel-Information"},
            },
    "276": {"name": "COCO VILLA 大洗",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Oarai-Hotels-Private-Villa-With-Sauna-Overlooking-The-Horizon-A-Front-Row-Seat-On-The-Ocean.h127293794.Hotel-Information"},
            },
    "277": {"name": "No.12 Kashima Fan Zone",
            "reason": "**expedia のURLが日本語のページを指していなかった。** 59件のうち34件が外国ドメイン（.com 7 / .co.uk 2 / .com.my 2 / .com.hk 2 / .com.ph 1 / .ca 1 / .com.sg 1 / .com.au 1）か、`.co.jp` でも `/en/` 付きの英語ページだった。**外国ドメインは通貨もその国のものになる。**\n\n変換は「ホストを `www.expedia.co.jp` に、`/en` を落とす」だけで、**施設を特定している `.hNNNNNNN.` は変えていない。**\n\n**Expedia は自動アクセスに「人間認証」を返して 429 で遮断するため、Agoda のような全件確認ができない。** 実機ブラウザで3つの型を1件ずつ確認した。\n\n  id=4   `.com.ph` → `.co.jp`（都市名あり・ドメイン跨ぎ）→ 「鴨川９１９」\n  id=115 `.co.jp/en/` → `.co.jp/`（同一ドメイン）→ 「飯塚邸」\n  id=119 `.com.hk/en/` → `.co.jp/`（**都市名なし・ドメイン跨ぎ**）→ 「SANU 2nd Home 那須2nd」\n\n3つとも日本語で正しい施設が表示された。**残りは同じ3つの型のいずれかなので型ごとの確認で代えている。1件ずつの確認はしていない。**\n\n変換で1件バグを出しかけた。`/en/` を落とすのに `path[4:]` と書いて**先頭のスラッシュまで削れ**、id=119 と id=276 が `https://www.expedia.co.jpSANU-...` になっていた（`path[3:]` が正しい）。（2026-09）",
            "set_villa": {"expedia": "https://www.expedia.co.jp/Kashima-Hotels-No12-Kashima-Fan-Zone.h115688772.Hotel-Information"},
            },
}
