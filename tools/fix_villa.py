...
FIXES = {
    "274": {"name": "サンライズヴィラ大洗",
            "reason": "公式サイトの構成上、サウナは客室ではなく施設共通設備。「施設紹介」ページでバーラウンジ・ガーデンプールと並んで「Spa & Sauna」が紹介され、営業時間5:00-9:00／14:00-23:00・貸切制90分・チェックイン時に申し込む方式。ゲストルームの客室設備一覧（冷暖房・電気ケトル・冷蔵庫・洗濯機・乾燥機等）にサウナは含まれない。貸切利用ページでも「設備・サービス：客室（3棟）・ガーデン・プール・バーラウンジ・サウナ」と客室と別に列挙され、「ご宿泊者様以外の方のサウナ、プールなどの施設利用○」と宿泊者以外の利用も認めている。全3棟が同時に滞在する構成のため shared（2026-08確認）",
            "remove_tags": ["sauna"],
            "set_spec": {"sauna_exists": {"v": "shared", "src": "desk", "at": "2026-08",
                                          "url": "https://sunrise-villa.jp/facility/"}}},
}
