...
FIXES = {
    "127": {"name": "VillaEL5",
            "reason": "既存の capacity=28 は根拠不明。公式サイト（stay-japan.tokyo/villa5/）は404で失効しており、OTA各社の掲載にも定員の記載がない。DBの feature は「6LDK一棟貸し185平米。最大5名同一料金」、desc は「200平米・7LDKの完全貸切別荘。5名様まで同一料金」と両者で間取り・面積が食い違い、いずれも28名の根拠にならない。誤った値を残すより未調査に戻す（2026-08確認）",
            "remove_spec": ["capacity"]},
}
