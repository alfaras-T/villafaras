...
FIXES = {
    "33": {"name": "and RIVER勝浦",
            "reason": "**`sauna_type: hut` の根拠が消えた。削除する。** 波V14-15 でサウナイキタイの「アウトドアサウナ」欄の**「サウナ小屋（屋外・水着着用）＝○」だけ**を根拠に記録したが、**この欄にバレルサウナの選択肢が存在しない**ことが分かった。\n\n  テントサウナ（常設・定期設置）／テントサウナ（レンタル）／テントサウナ（持込OK）／\n  **サウナ小屋（屋外・水着着用）**／サウナカー／川・滝・湖・海が水風呂\n\n**屋外の小型サウナ建屋はすべて「サウナ小屋」に丸められる。** 実例が id=93 ヴィラグリファーム七里岩で、タグは「サウナ小屋」なのに同じページの料金表が「■**バレルサウナ**＋水風呂 貸切・・・19,800円／日」と書いている。\n\nid=33 のページには「小屋」「バレル」という語が**タグ以外に一度も出てこない**ため、hut と barrel を区別できない。**未調査に戻す。**\n\n**以後の規約:**\n  `tent` … テントサウナの3タグは他と区別できるので**使える**\n  `hut`  … 「サウナ小屋」タグ**だけでは根拠にならない**。本文が「小屋」と書いているか、バレルを排除できる場合のみ\n  `indoor` … この欄は屋外設備の一覧なので**そもそも導けない**\n\n同じ理由で id=81 織之家・id=82 祝之家（どちらも「サウナ小屋」タグのみ）は記録を見送った。（2026-09確認）",
