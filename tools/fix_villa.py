...
FIXES = {
    "6": {"name": "CAP MARTIN Funny house",
            "reason": "**住所の枝番が誤っていた。261-3 ではなく 261-5。** 独立した3つの情報源がすべて一致し、郵便番号（299-2116）も3箇所とも同じ。\n\n  公式ACCESS「ADDRESS　千葉県安房郡鋸南町岩井袋**261-5**」\n  公式の予約エンジン「所在地　〒2992116千葉県安房郡鋸南町岩井袋**２６１−５**」\n  一休「住所：〒 299-2116　千葉県安房郡鋸南町岩井袋**261-5**」\n\n**国土地理院では枝番まで解決できず 261-3 と 261-5 が同じ点を返す**ため、座標との距離（どちらも0.33km）では区別できなかった。**この型は外部の記載でしか検出できない**（id=199 の「鎌原1054-116」と同じ）。（2026-09確認）",
            "set_villa": {"addr": "千葉県安房郡鋸南町岩井袋261-5"},
            },
    "208": {"name": "パノーラ熱海桜沢",
            "reason": "**`official` が `https://www.resolstay.jp/` というドメインルートで施設に到達しなかった。** resolstay は施設ごとに `/details/XXXX/` のページを持つので、全施設一覧からたどって特定した。\n\n  施設名「**パノーラ熱海桜沢**」／住所「〒413-0025　静岡県熱海市**桜木町32-8**」\n\nDBの施設名・住所と完全一致する。**2026-09 に15施設で同じ差し替えをしており、この件がその発端**（走査のきっかけになった施設）。（2026-09確認）",
            "set_villa": {"official": "https://www.resolstay.jp/details/panoraatamisakurazawa/"},
            },
}
