...
FIXES = {
    "275": {"name": "ときわ邸 M-GARDEN",
            "reason": "**住所が姉妹施設のものだった。1-2-43 は隣接する『清香庵M-GARDEN』の実在する住所で、ときわ邸は 1-2-45。** 別セッションの報告を受けて独立に3つの出典で確かめた。\n\n  一休 00051459「〒 310-0033 茨城県水戸市常磐町**1-2-45**」\n  公式（結婚式場側）フッタ「茨城県水戸市常磐町**1-2-45**」\n  運営の総合サイト m-garden.jp「ときわ邸M-GARDEN：〒310-0033 茨城県水戸市常磐町**1-2-45**／清香庵M-GARDEN：〒310-0033 茨城県水戸市常磐町**1-2-43**」\n\n清香庵は2024年9月1日グランドオープンの**別邸**（和食）で、1-2-43 はその住所。**単純な誤記ではなく id=239 AMAO VILLA・id=160 雅・仙石原・id=132/133 GEOSPOT に続く姉妹施設型の4例目。** 2棟は隣接しているためチャネルAの導出値には影響しない。\n\n**あわせて `official` を差し替えた。** `m-garden.official-wedding.jp` は結婚式場ポータルのサブドメインで、運営自身のドメインは `m-garden.jp`。こちらはレストラン・宿泊・結婚式を束ねる総合サイトで、**両施設の住所を並記しているのはこのページだけ**だった。（2026-09確認）",
            "set_villa": {"addr": "茨城県水戸市常磐町1-2-45",
                          "official": "https://m-garden.jp/"},
            },
}
