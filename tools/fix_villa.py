...
FIXES = {
    "143": {"name": "mysa hakone",
            "reason": "**`water_depth` の選択肢を体感区分からサウナイキタイのcm帯に置き換えたのに伴う再判定。** 出典ページの構造化欄は「**水深80~110cm**」で、`d80110` に当たる。\n\n旧値 `shoulder` は同じ欄の**備考**「1人用の、**肩まで浸かれる**プールが2つ置いております。」から採ったものだった。**ところがサウナイキタイ自身の尺度では 80~110cm は「腰」で、「肩」は 140cm~ である。** 検索の絞り込みが\n\n  20~40cm（脛）／40~60cm（膝）／60~80cm（股下）／**80~110cm（腰）**／110~140cm（胸）／**140cm~（肩）**\n\nと併記している。**施設の「肩まで浸かれる」は座って浸かる体感の表現で、水深そのものの区分とは一致しない。** 旧区分のまま推測していたら外していた。\n\n置き換えの理由は、**この項目を埋められる情報源がサウナイキタイだけ**で、そこがcmで持っているため。2026-09 の波V14-15 では15施設でcmの値が取れたのに、体感区分に読み替えられず1件も記録できなかった。（2026-09確認）",
            "set_spec": {"water_depth": {"v": "d80110", "src": "desk", "at": "2026-09",
