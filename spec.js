...
(function () {
  ...
  var O = {
    ...
    /* 区間は「下限を含み上限を含まない」。60分ちょうどは m60。
       2026-08 まで「30〜60分」「60〜90分」と書いており境界が重複していた。 */
    heattime: { u30: '30分未満', m30: '30分以上60分未満', m60: '60分以上90分未満',
                o90: '90分以上', always: '常時稼働' },
    ...
    /* 区間は「下限を含み上限を含まない」。15℃ちょうどは t1518、18℃ちょうどは t1822。
       2026-08 まで「10〜15℃」「15〜18℃」と書いており境界が重複していた。実際に
       15℃を t1518 と t1015 の両方で記録した施設があり、不整合が生じていた。 */
    wtemp:    { u10: '10℃未満', t1015: '10℃以上15℃未満', t1518: '15℃以上18℃未満',
                t1822: '18℃以上22℃未満', o22: '22℃以上' },
    wsrc:     { tap: '水道水', well: '井戸水・地下水', spring: '湧水', river: '川・湖' },
    // 2026-09: 体感区分（膝/腰/胸/肩）から**サウナイキタイのcm帯**に置き換えた。
    // この項目を埋められる情報源はサウナイキタイだけで、そこがcmで持っているため。
    // **体感の読み替えはサウナイキタイ自身が定義している。**検索の絞り込みが
    // 「80~110cm (腰)」「110~140cm (胸)」「140cm~ (肩)」と併記しており、
    // 旧区分で推測すると外れる（80~110cm は肩ではなく腰）。
    depth:    { d2040: '20〜40cm（脛）', d4060: '40〜60cm（膝）',
                d6080: '60〜80cm（股下）', d80110: '80〜110cm（腰）',
                d110140: '110〜140cm（胸）', d140: '140cm〜（肩）' },
